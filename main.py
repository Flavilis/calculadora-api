from fastapi import FastAPI , HTTPException     #classe principal que cria a aplicação
from pydantic import BaseModel #basaemodel define modelos de dados...é um modelo no final das contas     #HTTPExxception permite retorna erros do amno http com cod e mensagem de sms 
